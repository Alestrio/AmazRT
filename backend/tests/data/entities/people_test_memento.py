...
#  First semester Technical Degree project
#
from backend import Base, engine, Session  # import des composants base de données
from backend.data.entities.people.Customer import Customer  # Import de la classe client
from backend.data.entities.people.Operator import Operator  # import de la classe opérateur
from backend.data.entities.people.Supplier import Supplier  # import de la classe fournisseur
